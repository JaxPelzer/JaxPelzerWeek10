...
using JaxPelzerWeek10.Data;
using JaxPelzerWeek10.Models;

namespace JaxPelzerWeek10.Controllers
{
    ...
    public class CreditCardsController : ControllerBase
    {
        ...
        public CreditCardsController(Adventureworks2016Context context)
        {
            _context = context;
        }
